const taken = document.getElementById('wholePost');
console.log(taken)
...
dev.map((item, index)=>{
   ...
   <div class="user-post">
     <div class="user-post-header">
       <div class="post-info">
         <img src="${item.authorInfo.profile}" alt="" />
         <div class="user-details">
           <a class="author" href="#">${item.authorInfo.name}</a>
           <span
             >${item.authorInfo.timeAgo}
             <svg
               fill="currentColor"
               viewBox="0 0 16 16"
               width="1em"
     ...
     <div class="post-body">
       <div class="post-content">
         <p>
           ${item.contents.P_caption}
         </p>
       </div>
     </div>
     <div class="post-media">
       <img
         src="${item.contents.P_content}"
         alt=""
       />
     </div>
     <div class="post-comments">
       <div class="comments-header">
         <div class="reaction">
           ...
           <a href="#">Kajal Datta, Sufia Sepu and ${item.reaction.like} others</a>
         </div>
         <div class="counts">
           <a href="#">${item.reaction.comment} Comments</a>
         </div>
       </div>
...
//create a list of tag and print they're all then add color & bg after done it then add odd & even color
// const taken = document.getElementsByTagName('h2')
// for(i=0; i<taken.length;i++){
//     if(i % 2 === 0){
//         taken[i].style.color='red'
//     }else{
//         taken[i].style.color='green'
//     }
// }

// if(taken % 2 == 0){
//     taken.style.color='red';
// }else{
